...
public class DiskUnitTester0 {
	...
	/**
	 * Tests the disk creation, mounting and writing operations for DiskUnit.
	 * @param args
	 */
...
//			DiskUnit.createDiskUnit("disk5", 256, 8);
	...
	/** 
	 * Takes a string s and writes it into the disk specified by 
	 * dividing it into various blocks.
	 * @param s string to be written to the disk.
	 * @param d disk where string will be written.
	 */
	 ...
	 * the remainder of the data in the last 4 bytes of the corresponding block.
